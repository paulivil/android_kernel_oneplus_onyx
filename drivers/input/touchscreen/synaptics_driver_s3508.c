...
#ifdef VENDOR_EDIT
#define KEY_DOUBLE_TAP          KEY_POWER // 249 double tap to wake
#define KEY_GESTURE_DOWN_V      249 // draw ^ to do undefined action
#define KEY_GESTURE_CIRCLE      250 // draw circle to launch camera
